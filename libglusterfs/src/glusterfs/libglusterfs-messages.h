...
GLFS_MSGID(
    ...
    LG_MSG_IO_NOT_SUPPORTED, LG_MSG_IO_SYSCALL, LG_MSG_IO_RING_TOO_SMALL,
    LG_MSG_IO_STARTED, LG_MSG_IO_GETEVENTS_FAILED, LG_MSG_IO_TOO_MANY_ERRORS,
    LG_MSG_IO_NO_SQES, LG_MSG_IO_NO_CQES, LG_MSG_IO_SQE_PENDING,
    LG_MSG_IO_JOIN_FAILED, LG_MSG_IO_THREAD_FAILED, LG_MSG_IO_WORKER_STARTED,
    LG_MSG_IO_WORKER_STOPPED, LG_MSG_IO_WORKER_FAILED, LG_MSG_IO_WORKER_RESULT,
    LG_MSG_IO_STOP_LOST, LG_MSG_IO_FALLBACK, LG_MSG_IO_UNSTABLE);
